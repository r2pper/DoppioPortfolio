...
<html> 
	...
	<div class="recipe_content">
		...
		<div class="content_div">
			...
			<form name="delForm" action="/doppio/admin/admin_recipe/recipe_content_ncf.th?rnum=${vo.rnum }" method="post">
				<div class="admin_button">
					<button type="button" id="btnUpdate" onclick="location.href='http://localhost:9000/doppio/admin/admin_recipe/recipe_update_ncf.th?rnum=${vo.rnum }&rno=${rno}'">수정</button>
        	...
        	<div class="commentfield">
				...
				<form name="comment_write_ncf" action="doppio/admin/admin_recipe/recipe_write_ncf.th" method="post">
			           	...
			           	<textarea rows="1" cols="40" style="width: 600px;" placeholder="내용을 입력해 주세요" id="cmcomment" name="cmcomment"></textarea>
			          		<button type="button" class="enter" id="btnComm1" data-rnum="${vo.rnum}">등록</button>  
			    </form> 
			    </c:if> 
