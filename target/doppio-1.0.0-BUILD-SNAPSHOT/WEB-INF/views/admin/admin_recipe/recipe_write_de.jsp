		...
		<section class="board_write">
			...
			<form name="recipe_write_de" action="/doppio/admin/admin_recipe/recipe_write_de.th" method="post" enctype="multipart/form-data">
				...
				<table class="content_write" id="lasttable">
					...
					<tr>					
						<td colspan="2">
							<button type="button" class="btn_style2" id="btnRecipede">저장</button>
							<button type="button" class="btn_style2" id="btnCancel" onclick="location.href='http://localhost:9000/doppio/admin/admin_recipe/recipe_list_de.th?rcate=de'">취소</button>
