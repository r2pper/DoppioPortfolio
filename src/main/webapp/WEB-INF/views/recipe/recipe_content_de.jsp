...
<html> 
	...
	<body>
		...
		<!-- content -->
		<br>
		<a href="http://localhost:9000/doppio/recipe/recipe_list_de.th?rcate=de" id="tolist" class="tolist2"> >목록으로</a>
        	...
        	<div class="commentfield">
				...
				<form name="comment_write_cf" action="doppio/recipe/recipe_write_cf.th" method="post">
			           	...
			           	<textarea rows="1" cols="40" style="width: 600px;" placeholder="내용을 입력해 주세요" id="cmcomment" name="cmcomment"></textarea>
			          		<button type="button" class="enter w-btn-skin-outline" id="btnComm5" data-rnum="${vo.rnum}">등록</button>  
			    </form> 
			    </c:if> 
