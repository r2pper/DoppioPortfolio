...
<script src="http://localhost:9000/doppio/resources/js/admin_notice.js"></script>
		...
		<section class="board_list">
			...
			<table id="board_table">
				...
				<c:forEach var="vo" items="${list}">
					<tr class="boardhover">
						<td>${vo.rno }</td>
						<td><a href="http://localhost:9000/doppio/admin/admin_notice/notice_content.th?nnum=${vo.nnum }&rno=${vo.rno}" class="boardtitle">${vo.ntitle }</a></td>
						<td>${vo.id }</td>
						<td>${vo.ndate }</td>
						<td>${vo.nhits }</td>
					</tr>
