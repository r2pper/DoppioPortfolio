...
<body>
	...
	<div class="writecontent">
		<section class="board_write">
			...
			<form name="recipe_write" action="/doppio/admin/admin_recipe/recipe_update_ncf.th?rnum=${vo.rnum }" method="post" enctype="multipart/form-data">
				...
				<table class="content_write" id="lasttable">
					...
					<tr>					
						<td colspan="2">
							...
							<a href="http://localhost:9000/doppio/admin/admin_recipe/recipe_content_ncf.th?rnum=${vo.rnum }&rno=${vo.rno}"><button type="button" class="w-btn-outline w-btn-skin-outline">취소</button></a>
							<a href="http://localhost:9000/doppio/admin/admin_recipe/recipe_list_ncf.th"><button type="button" class="w-btn-outline w-btn-skin-outline">리스트</button></a>
						</td>
					</tr>
				</table>
				<br><br><br>
