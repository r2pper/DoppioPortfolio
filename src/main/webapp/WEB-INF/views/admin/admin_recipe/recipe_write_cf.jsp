		...
		<section class="board_write">
			...
			<form name="recipe_write_cf" action="/doppio/admin/admin_recipe/recipe_write_cf.th" method="post" enctype="multipart/form-data">
				...
				<table class="content_write" id="lasttable">
					...
					<tr>					
						<td colspan="2">
							<button type="button" class="w-btn-outline w-btn-skin-outline" id="btnRecipecf">저장</button>
							<button type="button" class="w-btn-outline w-btn-skin-outline" id="btnCancel" onclick="location.href='http://localhost:9000/doppio/admin/admin_recipe/recipe_list_cf.th?rcate=cf'">취소</button>
