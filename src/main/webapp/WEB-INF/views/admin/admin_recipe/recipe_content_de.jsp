		...
		<div class="content_div">
				...
				<div class="table_div">
						<table class="content_table">
							<tr>
								<th> ${vo.rhits} </th><td> 번 조회된 <b style="font-size: 15px;">Dessert 카테고리</b> 레시피입니다. </td>
							</tr>
						</table>
				</div><br>
			<div class="iframediv">
        	...
        	<div class="commentfield">
				...
				<form name="comment_write_de" action="doppio/admin/admin_recipe/recipe_write_de.th" method="post">
			           	...
			           	<textarea rows="1" cols="40" style="width: 600px;" placeholder="내용을 입력해 주세요" id="cmcomment" name="cmcomment"></textarea>
			          		<button type="button" class="enter w-btn-skin-outline" id="btnComm2" data-rnum="${vo.rnum}">등록</button>  
			    </form> 
			    </c:if> 
