	...
	<body>
		...
		<div class="recipe_buy">
			...
			<form name="delForm" action="/doppio/admin/admin_package/package_content_ncf.th?pnum=${vo.pnum }" method="post">
				<table>
				<tr>
					<td><button type="button" class="w-btn-outline w-btn-outline-package-admin" onclick="location.href='http://localhost:9000/doppio/admin/admin_package/package_update_ncf.th?pnum=${vo.pnum }&rno=${rno}'">수정</button></td>
				</tr>
				<tr>
