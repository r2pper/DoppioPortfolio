				...
				<table class="content_write" id="lasttable">
					...
					<tr>					
						<td colspan="2">
							...
							<a href="http://localhost:9000/doppio/admin/admin_package/package_content_cf.th?pnum=${vo.pnum }&rno=${vo.rno}"><button type="button" class="w-btn-outline w-btn-skin-outline">취소</button></a>
						</td>
					</tr>
				</table>
				<br><br><br>
