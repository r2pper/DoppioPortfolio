		...
		<section class="board_write">
			...
			<form name="package_write_de" action="/doppio/admin/admin_package/package_write_de.th" method="post" enctype="multipart/form-data">
				...
				<table class="content_write" id="lasttable">
					...
					<tr>					
						<td colspan="2">
							<button type="button" class="w-btn-outline w-btn-skin-outline" id="btnPackageDe">저장</button>
							<a href="http://localhost:9000/doppio/admin/admin_package/package_list_de.th"><button type="button" class="w-btn-outline w-btn-skin-outline">취소</button></a>
						</td>
					</tr>
				</table>
				<br><br><br>
