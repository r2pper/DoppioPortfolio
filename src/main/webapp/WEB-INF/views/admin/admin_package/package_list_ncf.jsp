	...
	<body>
		...
		<div class="recipe_list">
			...
			<div class="recipe_header">
				<img alt="noncoffee" src="http://localhost:9000/doppio/resources/img/package_noncoffee_bn.png">
			</div>
		<br><br>
		...
		<div class="purchasebtn">
				<a href="http://localhost:9000/doppio/admin/admin_package/package_write_ncf.th"><button type="submit" class="w-btn-outline w-btn-skin-outline">제품 등록</button></a>
		</div>
				...
				<c:forEach var="vo" items="${list}">
					<div class="imgcon1">
						...
						<c:if test="${vo.psfile != null}">
							<a href="package_content_ncf.th?pnum=${vo.pnum }&rno=${vo.rno}">
