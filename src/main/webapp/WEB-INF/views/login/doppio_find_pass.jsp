...
<body>
	...
	<div class="findDiv">
	<form action="/doppio/login/doppio_find_pass_result.th" method = "POST">
		...
		<table class="find_table">
			...
			<tr>
				<td class="find_td">&nbsp;I D</td>
				<td><input type="text" name="id" id="id" class = "btn-id" placeholder = "등록한 ID"></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="find_td">E - m a i l</td>
				<td><input type="text" name="email" id="email" class = "btn-email" placeholder = "이메일주소를 '@' 포함 입력"></td>
			</tr>
			<tr>
				<td colspan="2">
		...
		<!-- <div class ="btnSearch">
			<input type="submit" name="enter" id=findBtn class="findBtn" value="찾기" >
			<br>
			<input type="button" name="cancle" value="취소" class="findBtn" onClick="location.href='http://localhost:9000/doppio/login/doppio_login.th'">
	 	</div> -->
	</form>
	</div>
