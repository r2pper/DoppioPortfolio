...
<body>
	...
	<div id="containdiv">
		<section>
			...
			<table id="headtable">
				<tr>
					<td class="tolistTd"><a href="http://localhost:9000/doppio/notice/notice_list.th" id="tolist">> 목록으로</a></td>
				</tr>
				<tr id="hits">
			...
			<hr id="middleline">
			<br>
			<%-- <form name="delForm" action="/doppio/notice/notice_content.th?nnum=${vo.nnum }" method="post">
